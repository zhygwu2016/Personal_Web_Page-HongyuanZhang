...
variable "github_token" {
  type = "string"
  default = "89a7504e3b711a1a8eb18b3f2dbf31ec24182b32"
}

variable "github_repo" {
  type = "string"
  default = "Personal_Web_Page-HongyuanZhang"
}

provider "aws" {
  region     = "us-west-1"
  access_key = "AKIAJWH4KG7YRMR2ZS5Q"
  secret_key = "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"
}
